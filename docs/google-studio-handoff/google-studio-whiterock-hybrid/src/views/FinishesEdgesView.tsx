    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24 space-y-20">
      ...
      <div className="space-y-4 max-w-4xl">
        ...
        <p className="text-base sm:text-xl text-[#6e6e73] leading-relaxed max-w-3xl font-normal">
          From 85+ GU mirror-polished quartz to tactile honed silk finishes and 45° mitered waterfall returns, our automated edge-profiling lines deliver ±0.3mm tolerance across standard 2cm, 3cm, and laminated 4cm stone assemblies.
        </p>
      </div>
      ...
      {/* Part 3: CUPC Sink Integration Standard */}
      <section className="apple-card-dark rounded-[3rem] p-10 sm:p-14 text-white space-y-8">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
          <div className="space-y-2 max-w-2xl">
            ...
            <h2 className="text-2xl sm:text-4xl font-bold tracking-tight text-white">
              CUPC Porcelain Sinks Factory Pre-Glued & Packaged
            </h2>
            <p className="text-xs sm:text-sm text-[#a1a1a6] leading-relaxed">
              Eliminate on-site plumbing labor and sink alignment risks. Our Vietnam factory pre-attaches vitreous china rectangular basins with structural high-strength epoxy, silicone sealing, and stainless steel support clips.
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 pt-4 border-t border-white/10 text-xs">
          <div className="p-5 rounded-2xl bg-white/5 border border-white/10 space-y-1">
            <strong className="tech-badge text-amber-300 block">cUPC CERTIFIED</strong>
            <p className="text-[#a1a1a6]">Meets North American plumbing codes for commercial & residential use.</p>
          </div>
          <div className="p-5 rounded-2xl bg-white/5 border border-white/10 space-y-1">
            <strong className="tech-badge text-amber-300 block">4" OR 8" FAUCET SPREADS</strong>
            <p className="text-[#a1a1a6]">Single-hole, 4" centerset, or 8" widespread pre-drilled with CNC accuracy.</p>
          </div>
          <div className="p-5 rounded-2xl bg-white/5 border border-white/10 space-y-1">
            <strong className="tech-badge text-amber-300 block">DROP-TESTED CRATING</strong>
            <p className="text-[#a1a1a6]">Sinks cushioned with high-density EPE foam inside ISPM-15 export crates.</p>
          </div>
        </div>
      </section>
    </div>
